...
### Примечания
* забей link:css, получи <link rel="stylesheet" href="style.css">
* забивай полные адреса, чтобы ленивые копировщики не могли просто украсть твою страничку
* прошли CSS selectors
* fonts.google.com - бесплатные шрифты от гугла, можно скачать или взять линк от Google
* шрифты могут некорректно работать с кириллицей, надо проверять
    * у гугла на сайте можно на это фильтровать
* class может использоваться как id, если все классы уникальные
* дз - разбить на три столбика
